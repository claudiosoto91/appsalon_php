...
function mostrarResumen(){
    ...
    if ( Object.values(cita).includes('') || cita.servicios.length === 0 ){ //Se itera sobre el objecto cita para acceder a verificar que no esten vacios
    ...
    //Iterarndo y mostrando los servicios
    servicios.forEach(servicio =>{
